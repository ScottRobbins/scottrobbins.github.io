...
That will also be pulled from the cache, since all of the information required to satisfy the query was cached as a result of your earlier **_getBooksWithAuthors_** query.
